...
async def main():
    ...
    print("  7. StrategyGeneratorAgent  — auto-generates strategies (Hermes)")
    print("  8. TelegramCallbackPoller  — Telegram buttons")
    print("  9. StrategyEngine          — rule evaluation")
    print("  10. ServiceSupervisor      — health monitoring")
    print()
